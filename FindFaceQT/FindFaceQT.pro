...
LIBS += C:/opencv-build/bin/libopencv_objdetect340.dll
LIBS += C:/opencv-build/bin/libopencv_shape340.dll
LIBS += C:/opencv-build/bin/libopencv_stitching340.dll
LIBS += C:/opencv-build/bin/libopencv_superres340.dll
LIBS += C:/opencv-build/bin/libopencv_ml340.dll
